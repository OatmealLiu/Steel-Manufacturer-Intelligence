...
def plot_one_box(x, im, color=(128, 128, 128), label=None, line_thickness=3, angle=False):
    ...
    if label:
        ...
        cv2.putText(im, label, (c1[0], c1[1] - 2), 0, tl / 4, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
        # cv2.putText(im, label, (0, 30),cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        rot_label = "Rotation Angle: [ " + str(global_rotation) + " degrees ]"
        cv2.putText(im, rot_label, (0, 30), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
